...
set xlabel "Mirror Position (a.u.)"
set ylabel "Intensity (a.u.)"
set title "Interfergoram (original and after interpolation/deglitching)"
plot ".tmp_fts2_aig_ifgm_orig.dat" with lines title "Original Interferogram", ".tmp_fts2_aig_ifgm_interp.dat" with lines title "Interpolated/deglitched Interferogram"
#    EOF
