...
set xlabel "Reduced Wavenumber (a.u.)"
set ylabel "Intensity (a.u.)"
set title "Phase Fitting"
plot ".tmp_fts2_aig_phase.dat" using 1:2 with lines title "Fitting Phase", ".tmp_fts2_aig_phase.dat" using 1:3 with linespoints title "Original Phase"
#    EOF
