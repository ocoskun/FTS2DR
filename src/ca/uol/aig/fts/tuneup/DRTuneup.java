...
*/
     ...
     public void initDRFrame()
     {
          ...
          drFrame.setIconImage(createImageIcon());
    ...
    protected static Image createImageIcon()
    {
        java.net.URL imgURL = DRTuneup.class.getResource("/res/DRTuneup.png");
        if(imgURL != null)
    ...
    class fitsFileFilter extends javax.swing.filechooser.FileFilter
    {
         public boolean accept(File file)
         {
              String filename = file.getName();
              return filename.endsWith(".fits") || file.isDirectory();
         }
         public String getDescription()
         {
              return "Spire Fits Format(*.fits)";
         }
    }
    ...
    class MenuEventDRFrame implements ActionListener
    {
         public void actionPerformed(ActionEvent e)
         {
              ...
              if(menuName.equals("Choose a data file ..."))
              {
                    ...
                    fc.addChoosableFileFilter(new fitsFileFilter());
                    ...
                    if(ret == JFileChooser.APPROVE_OPTION)
                    {
                        ...
                        {
                            instrument = "SpireFits";
                            drFrame.setTitle("Herschel Spire Data Reduction");
                        }
                        if(fileName.endsWith("sdf"))
                        {
                            instrument = "Scuba2NDF";
                            drFrame.setTitle("Scuba-2 FTS Data Reduction");
                        }
...
//        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
     ...
     private JPanel createParametersPane()
     {
          ...
          Integer[] height_range = new Integer[66]; /*new Integer[32];*/
