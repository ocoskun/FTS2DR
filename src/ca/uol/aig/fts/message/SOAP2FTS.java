...
public class SOAP2FTS
{
     ...
     int dsSize  = 300;
     int ssSize  = 300;
     int phaseFittingdegree = 2;
     double weight_limit = 0.01;
     double wn_lBound = 0D;
     double wn_uBound = 1.0D;
     ...
     /**
      * start a SOAP server.
      * @param deployURL the path (in URL format) of the web service definition file.
      * @param soapServerPort the socket port of this SOAP server.
      */
     public void startSOAPServer(URL deployURL, int soapServerPort)
     {
         try 
         {
     ...
     public static void main(String[] arg)
     {
          ...
          URL deployURL = sf.getClass().getResource("/res/fts2deploy.wsdd");
          sf.startSOAPServer(deployURL, soapServerPort);
     }     
}
