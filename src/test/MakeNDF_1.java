...
public class MakeNDF_1 
{
     ...
     public void saveMirrorPos(float[] pos)
     {
          try
          {
              ...
              hdsInterferogram.datFind("MORE").datFind("JCMTSTATE").datErase("FTS_POS");
...
//                System.out.println(k + ":" + "max_coeff_x = " + max_coeff_x);
     ...
     public static void main(String[] args)
     {
           ...
           System.out.println("MakeNDF_1: OUT = " + outfile);
           MakeNDF_1 mn = new MakeNDF_1(outfile);
